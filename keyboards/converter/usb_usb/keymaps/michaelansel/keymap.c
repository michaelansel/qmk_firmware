...
*/
  ...
  [BASE] = LAYOUT_kinesis(
    ...
    CW_TOGG,   HR_A,      HR_S,      HR_D,      HR_F,      KC_G,                                                                              KC_H,      HR_J,      HR_K,      HR_L,      HR_SCLN,   XXXXXXX,
  ...
  // Ternary lmod: Aerospace window management (mod-morph verb selection on JKLI)
  // Home row mods select verb: no mod=focus  shift=move  gui=swap  alt=join  shift+gui=resize
  [WIN] = LAYOUT_kinesis(
    XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,         XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,
    XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,                                                                           XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,
    XXXXXXX,   XXXXXXX,   AE_CLOSE,  XXXXXXX,   XXXXXXX,   XXXXXXX,                                                                           TD(TD_AE_SEND), AE_WS_P, AE_DIR_U, AE_WS_N,   AE_TGFT,   XXXXXXX,
    XXXXXXX,   OSM(MOD_LCTL),   OSM(MOD_LALT),   OSM(MOD_LGUI),   OSM(MOD_LSFT),   AE_EQLS,                                                   AE_FMON,   AE_DIR_L,  AE_DIR_D,  AE_DIR_R,  AE_TGAC,   AE_BANDF,
    XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   AE_TRST,                                                                           XXXXXXX,   AE_DFSP,   XXXXXXX,   AE_DFNS,   AE_TGRT,   XXXXXXX,
               XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,                                                                                                 XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,
                                                           _ENTRY_,   XXXXXXX,                                                     XXXXXXX,   HS_MENU,
                                                                      XXXXXXX,                                                     XXXXXXX,
                                                XXXXXXX,   XXXXXXX,   XXXXXXX,                                                     XXXXXXX,   AE_FULL,   LEADERK
  ),
